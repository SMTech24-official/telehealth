...
const services: Service[] = [
    ...
    { name: "EMDR Consultation", link: "/our-services/emdr-consultation" },
    { name: "Rapid Resolution Therapy", link: "/our-services/rapid-resolution-therapy" },
    { name: "Sensorimotor Psychotherapy", link: "/our-services/sensorimotor-psychotherapy" },
    { name: "Somatic Psychotherapy", link: "/our-services/somatic-psychotherapy" },
    { name: "Brainspotting Therapy", link: "/our-services/brainspotting-therapy" },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/aboutUs" className="text-gray-300 hover:text-secondary transition-colors">
                                    About us
                                </Link>
                            </li>
                            <li>
                        ...
                        <ul className="space-y-2">
                            {
                                services.map((data: Service, idx: number) => <li key={idx}>
                                    <Link href={data.link} className="text-gray-300 hover:text-secondary transition-colors">
                                        {data.name}
                                    </Link>
                                </li>)
                            }
                    ...
                    <div className="space-y-4 col-span-2">
                        ...
                        <Link href={"/"} className="text-gray-300 hover:text-secondary transition-colors flex items-center gap-2">
