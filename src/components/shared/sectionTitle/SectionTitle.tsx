    ...
    return (
        <div className="mb-12">
            ...
            <div className={`grid ${sideText ? "lg:grid-cols-2 xl:grid-cols-3" : "grid-cols-1"} `}>
                <h2 className={`md:text-3xl ${sideText ? "col-span-1 xl:col-span-2" : "col-span-1"}  sm:text-2xl xl:text-6xl font-medium text-black mb-2 sm:mb-4 font-outfit ${white ? "text-white" : "text-black"}`}>{title}</h2>
