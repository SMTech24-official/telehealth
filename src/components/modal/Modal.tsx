            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 z-50 flex justify-end md:justify-center items-end md:items-center h-[90vh] mt-auto md:h-full"
                    >
                        ...
                        <div className="bg-white h-full md:h-auto md:rounded-xl shadow-xl z-30 overflow-hidden relative">
                            ...
                            {/* Modal Body */}
                            <div className="p-4 flex flex-col h-full w-full md:h-auto relative">
                                <div className="flex-grow overflow-y-auto w-[calc(100vw-20px)] md:w-full">{children}</div>
                            </div>
                        </div>
                    </motion.div>
                </>
