...
export const ConsultationCard = ({
    availability, description, hourlyRate, imageUrl, location, name, onMessage, onVisitProfile, rating, skills, title
        ...
        <div className={`w-full bg-white border-gray-200  p-6 space-y-4 `}>
            ...
            <div className="flex items-start justify-between">
                ...
                <button className="text-gray-400 hover:text-gray-500">
                    <LuBookmark className="w-6 h-6 hover:text-secondary" />
                </button>
            </div>
