...
const Education: React.FC<EducationProps> = ({ institution, degree, startYear, endYear, description, imageSrc, showImage = true }) => {
    return (
        <div className=''>
            ...
            {
                showImage && <Image src={imageSrc || "https://randomuser.me/api/portraits/women/2.jpg"} alt='' width={200} height={200} className='max-w-[170px] max-h-[70px] w-full h-full mt-2' />
            }
